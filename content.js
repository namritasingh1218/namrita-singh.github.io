window.siteContent = {
  meta: {
    ...
    description:
      "Namrita Singh is a Data Analyst with 4+ years of experience in SQL, Power BI, Python, and Azure. Based in Gurugram, India.",
  },
...
WHERE   expertise IN ('SQL', 'Power BI', 'Python')
  ...
  AND   status = 'available';`,
      rows: [
        ...
        { key: "experience", value: "4+ years @ Cognizant" },
    ...
    ctas: [
      ...
      {
        text: "Resume ↓",
        href: "public/Namrita_Singh_Resume.pdf",
  ...
  about: {
    ...
    bio: [
      "I'm a Data Analyst with 4+ years of experience at Cognizant Technology Solutions and a strong academic foundation in Statistics — M.Sc. and B.Sc. both at 9.0 CGPA from Aligarh Muslim University.",
    ...
    cards: [
      {
        ...
        desc: "Built an end-to-end retail analytics solution using Python ETL, MySQL, SQL, Power BI, and Excel. Developed interactive dashboards to analyze sales, customer, product, and payment performance.",
        tags: ["Python", "MySQL", "SQL", "Power BI", "Excel"],
        image: {
          src: "public/Retail-Analitics-Dashboard.png",
          alt: "Retail Analytics Dashboard preview",
        },
        href: "https://github.com/namritasingh1218/Retail-Analytics-Dashboard",
      ...
      },
      {
        ...
        image: {
          src: "public/SQL-Projects.png",
          alt: "SQL data analysis project preview",
        },
        href: "https://github.com/namritasingh1218/sql-projects",
        linkText: "View on GitHub",
      },
      {
        type: "py",
        ...
        image: {
          src: "public/Python-Projects.png",
          alt: "Python analytics project preview",
        },
        href: "https://github.com/namritasingh1218/python-data-analytics-projects",
        linkText: "View on GitHub",
      },
      {
        type: "bi",
        ...
        image: {
          src: "public/PowerBI-Projects.png",
          alt: "Power BI dashboard project preview",
        },
        href: "https://github.com/namritasingh1218/power-bi-projects",
        linkText: "View on GitHub",
      },
      {
        type: "academic",
  ...
  education: {
    ...
    certifications: [
      ...
      { name: "Power BI Essentials", by: "Udemy", badge: "Certified" },
    ],
  },
  ...
  contact: {
    ...
    subtext:
      "Open to Data Analyst roles, contract projects, and collaborations. Let's talk about how I can turn your data into decisions.",
    links: [
      {
        href: "mailto:namritasingh1218@gmail.com",
        type: "email",
        label: "Email",
        value: "namritasingh1218@gmail.com",
      },
      {
        href: "tel:+917037036551",
        type: "phone",
        label: "Phone",
        value: "+91 7037036551",
      },
      {
        href: "https://www.linkedin.com/in/namrita-singh-ab08111b2",
        type: "linkedin",
        label: "LinkedIn",
        value: "namrita-singh-ab08111b2",
        external: true,
      },
      {
        href: "https://github.com/namritasingh1218",
        type: "github",
        label: "GitHub",
        value: "namritasingh1218",
        external: true,
      },
    ],
    form: {
